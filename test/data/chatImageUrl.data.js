const { kb_querys } = require("./chat.data");

module.exports= {
    accountUnloackResponse:{
        Image_1:"(https://steparag73qkgzz2fvpvs.blob.core.windows.net/kb-mcdretail/images/c5fa7754-4ac8-4666-930b-5a605e3e234a.png",
        Image_2:"(https://steparag73qkgzz2fvpvs.blob.core.windows.net/kb-mcdretail/images/d127cb59-f841-4fc5-a368-e4cb1856ee5d.png",
        Image_3:"(https://steparag73qkgzz2fvpvs.blob.core.windows.net/kb-mcdretail/images/1252eba4-8d36-4d93-8d3e-6fe253371341.png",
    ...
    kb_querys:{
        accountUnlockQuery: `How can I lock my account using biometric or PIN on my personal device?`
    }
}